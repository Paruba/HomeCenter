...
namespace Boiler.Server.Migrations
{
    ...
    [Migration("20231203141945_AddedIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationRoleModelApplicationUserModel", b =>
                {
                    ...
                    b.ToTable("ApplicationRoleModelApplicationUserModel", "public");
                });
            ...
            modelBuilder.Entity("ApplicationRoleModelApplicationUserModel", b =>
                {
                    b.HasOne("Boiler.Server.Models.Identity.ApplicationRoleModel", null)
                        .WithMany()
                        .HasForeignKey("RolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Boiler.Server.Models.Identity.ApplicationUserModel", null)
                        .WithMany()
